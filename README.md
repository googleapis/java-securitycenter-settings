...
```Groovy
implementation 'com.google.cloud:google-cloud-securitycenter-settings:0.14.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-securitycenter-settings" % "0.14.0"
```
