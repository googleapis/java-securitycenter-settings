...
public interface ComponentSettingsOrBuilder extends
   ...
   * <code>map&lt;string, .google.cloud.securitycenter.settings.v1beta1.ComponentSettings.DetectorSettings&gt; detector_settings = 4;</code>
   */
  boolean containsDetectorSettings(
      java.lang.String key);
  /**
   * Use {@link #getDetectorSettingsMap()} instead.
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, com.google.cloud.securitycenter.settings.v1beta1.ComponentSettings.DetectorSettings>
  getDetectorSettings();
  /**
   * <pre>
   * Settings for detectors.  Not all detectors must have settings present at
   ...
   */
  com.google.cloud.securitycenter.settings.v1beta1.ContainerThreatDetectionSettings getContainerThreatDetectionSettings();
  /**
   * <pre>
   * Container Threate Detection specific settings
   * For component, expect CONTAINER_THREAT_DETECTION
   ...
   * <code>.google.cloud.securitycenter.settings.v1beta1.ContainerThreatDetectionSettings container_threat_detection_settings = 41;</code>
   */
  com.google.cloud.securitycenter.settings.v1beta1.ContainerThreatDetectionSettingsOrBuilder getContainerThreatDetectionSettingsOrBuilder();
   ...
   */
  com.google.cloud.securitycenter.settings.v1beta1.EventThreatDetectionSettings getEventThreatDetectionSettings();
  /**
   * <pre>
   * Event Threat Detection specific settings
   * For component, expect EVENT_THREAT_DETECTION
   ...
   * <code>.google.cloud.securitycenter.settings.v1beta1.EventThreatDetectionSettings event_threat_detection_settings = 42;</code>
   */
  com.google.cloud.securitycenter.settings.v1beta1.EventThreatDetectionSettingsOrBuilder getEventThreatDetectionSettingsOrBuilder();
   ...
   */
  com.google.cloud.securitycenter.settings.v1beta1.SecurityHealthAnalyticsSettings getSecurityHealthAnalyticsSettings();
  /**
   * <pre>
   * Security Health Analytics specific settings
   * For component, expect SECURITY_HEALTH_ANALYTICS
   ...
   * <code>.google.cloud.securitycenter.settings.v1beta1.SecurityHealthAnalyticsSettings security_health_analytics_settings = 44;</code>
   */
  com.google.cloud.securitycenter.settings.v1beta1.SecurityHealthAnalyticsSettingsOrBuilder getSecurityHealthAnalyticsSettingsOrBuilder();
   ...
   */
  com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScanner getWebSecurityScannerSettings();
  /**
   * <pre>
   * Web Security Scanner specific settings
   * For component, expect WEB_SECURITY_SCANNER
   ...
   * <code>.google.cloud.securitycenter.settings.v1beta1.WebSecurityScanner web_security_scanner_settings = 40;</code>
   */
  com.google.cloud.securitycenter.settings.v1beta1.WebSecurityScannerOrBuilder getWebSecurityScannerSettingsOrBuilder();

  public com.google.cloud.securitycenter.settings.v1beta1.ComponentSettings.SpecificSettingsCase getSpecificSettingsCase();
}
